...
public class GetAgentByEmailQueryHandler: IRequestHandler<GetAgentByEmailQuery, BaseResponse<GetAgentDto>>
{
    ...
    #region Constructor
    public GetAgentByEmailQueryHandler(IUnitOfWork unitOfWork)
    {
        _unitOfWork = unitOfWork;
    }
    #endregion

    public async Task<BaseResponse<GetAgentDto>> Handle(GetAgentByEmailQuery request, CancellationToken cancellationToken)
    {
        try
        {
